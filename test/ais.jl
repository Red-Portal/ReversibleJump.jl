...
@testset "proposal_ais" begin
    ...
    @testset for annealing_path in [GeometricPath(4), ArithmeticPath(4)]
        ...
        @testset "birth" begin
            ...
            state′, ℓr = ReversibleJump.propose_jump(
                rng, ReversibleJump.Birth(), jump, state, mcmc, model
            )
        ...
        @testset "death" begin
            ...
            state′, ℓr = ReversibleJump.propose_jump(
                rng, ReversibleJump.Death(), jump, state, mcmc, model
            )
